...
<nav class="navibar">
  ...
  <ul class="navibar__list">
    ...
    <div class="navibar__user">
      <a class="navibar__user__pic" href="/profile" style="background-image: url('@guest{{asset('img/profile-placeholder.png')}} @else /storage/{{Auth::user()->user_image }}@endguest')"></a>
